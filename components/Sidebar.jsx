...
const Sidebar = () => {
  const { isAuthenticated, isWeb3Enabled, nickname, setNickname, username, handleSetUsername } = useContext(AmazonContext);
        ...
        {isAuthenticated && isWeb3Enabled ? (
          <>
            <div className={styles.profileContainer}>
              <Image src={`https://avatars.dicebear.com/api/pixel-art/${username}.svg`} alt="profile" className={styles.profilePic} height={100} width={100} />
            </div>
            {!username ? (
              <>
