    ...
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.tableContainer}>
          {ownedItems ? <div className={styles.pageTitle}>Purchase History</div> : <div className={styles.pageTitle}>No Purchase History</div>}
          <div className={styles.transactions}>{ownedItems && ownedItems.map((item, index) => <Transaction key={index} item={item} />)}</div>
        </div>
      </div>
    </div>
  );
